 ...
 *   const maxAccounts = getLimit("max_bank_accounts", 1);
 *
...
export function useAccess() {
   ...
   * Useful for plan limits like max_bank_accounts, max_projects, etc.
   *
   * @param key          - The access key (e.g. "max_bank_accounts")
