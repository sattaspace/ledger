...
/**
 * LoginForm — Vue interactive island for the sister domain login page.
 *
 * Handles POST /auth/login → stores JWT tokens via auth.ts
 * On successful login, redirects to /dashboard.
 *
 * Links for "Create an account" and "Forgot password?" redirect to the
 * Sattabase base domain since sister domains only have LOGIN and LOGOUT screens.
 */
...
/** Redirect to base domain for account registration. */
function goToRegister(): void {
  redirectToBase("/auth/register");
}

/** Redirect to base domain for password reset. */
