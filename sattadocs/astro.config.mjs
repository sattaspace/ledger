...
export default defineConfig({
  ...
  integrations: [
    ...
    starlight({
      ...
      description:
        "Official documentation for SattaSpace Ecosystem - SattaBase and more",
      ...
      social: [
        {
          icon: "github",
          label: "GitHub",
          href: "https://github.com/sattaspace",
        },
      ],
      ...
      head: [
        ...
        {
          tag: "meta",
          attrs: { property: "og:site_name", content: "SattaSpace Docs" },
        },
        { tag: "meta", attrs: { property: "og:locale", content: "en_US" } },
        {
          ...
          attrs: {
            property: "og:image",
            content: "https://docs.sattaspace.com/logo.png",
          },
        },
        ...
        },
        {
          ...
          attrs: {
            ...
            content: "SattaSpace Documentation",
          },
        },
        ...
        {
          tag: "meta",
          attrs: { name: "twitter:site", content: "@sattaspace" },
        },
        {
          tag: "meta",
          attrs: {
        ...
        {
          tag: "link",
          attrs: { rel: "canonical", href: "https://docs.sattaspace.com/" },
        },
        ...
        {
          tag: "meta",
          attrs: { name: "msapplication-TileColor", content: "#6366f1" },
        },
